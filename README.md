...
```
cd existing_repo
git remote add origin https://gitlab.com/Bdavi/querybot.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/Bdavi/querybot/-/settings/integrations)
...
>>>>>>> 9f4ab8ca4dd086862c278ae8f22ae278a98137e9
